namespace System.Drawing.Analysis
{
    ...
    public abstract class BitmapPixelProvider : IPixelProvider
    {
        private readonly Bitmap _internalBitmap;
        /// <summary>Gets the <see cref="T:System.Drawing.Bitmap"/> the current <see cref="T:System.Drawing.Analysis.BitmapPixelProvider" /> instance uses for its pixel data.</summary>
        public Bitmap Bitmap { get { return _internalBitmap; } }

        /// <summary>Gets a value indicating whether the bitmap object is getting disposed if this <see cref="T:System.Drawing.Analysis.BitmapPixelProvider" /> instance is disposed.</summary>
        public bool DisposeBitmapOnFinalize { get; set; }

        /// <summary> Gets the width and height, in pixels, of this provider.</summary>
        public Size Size { get; private set; }

        /// <summary>Initializes a new instance of the <see cref="T:System.Drawing.Analysis.BitmapPixelProvider" /> class with the specified bitmap image.</summary>
        /// <param name="bitmap">The bitmap to use</param>
        /// /// <param name="disposeBitmapOnFinalize">A value indicating whether the bitmap object is getting disposed if this <see cref="T:System.Drawing.Analysis.BitmapPixelProvider" /> instance is disposed.</param>
        ...
        public abstract NativeColor GetPixel(int x, int y);

        /// <summary>Gets The <see cref="T:System.Drawing.NativeColor"/> of the specified pixel in the provider.</summary>
        /// <param name="point">The coordinates of the pixel to retrieve.</param>
        /// <returns>A NativeColor structure that represents The <see cref="T:System.Drawing.NativeColor"/> of the specified pixel.</returns>
        public abstract NativeColor GetPixel(Point point);
